...
export default function Header({ img, about, links }) {
  return (
    <div className="mx-auto grid grid-cols-1 gap-8 md:grid-cols-2 flex-wrap md:items-center md:h-screen md:w-[80vw] pt-20">
      ...
      {/* <div className="p-4"> */}
      <picture className="w-full max-w-lg mx-auto p-4">
        <source
          srcSet={img} />
        <img
          src={img}
